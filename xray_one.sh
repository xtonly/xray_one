...
run_install_ss() { local port="$1" password="$2"; run_core_install || exit 1; local ss_inbound; ss_inbound=$(build_ss_inbound "$port" "$password"); write_config "[$ss_inbound]"; restart_xray; success "Shadowsocks 安装成功！"; view_all_info; }
