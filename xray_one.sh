...
# --- 全局常量 ---
readonly SCRIPT_VERSION="v20250910-0415"
...
# --- 核心配置生成函数 ---
generate_ss_key() {
    # SS2022 需要 16 或 32 字节的密钥, base64编码
...
run_install_ss() { local port="$1" password="$2"; run_core_install || exit 1; local ss_inbound; ss_inbound=$(build_ss_inbound "$port" "$password"); write_config "[$ss_inbound]"; restart_xray; success "Shadowsocks (SS2022) 安装成功！"; view_all_info; }
